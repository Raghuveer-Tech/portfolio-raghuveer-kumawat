export default function Resume() {
  return (
    <section
      id="resume"
      className="py-20 px-4 sm:px-6 bg-[#0b0b0b] text-white flex justify-center items-center"
    >
      <div className="max-w-4xl w-full">
        {/* Section Heading */}
        <div className="text-center mb-12">
          <h2 className="text-xs uppercase tracking-widest text-orange-500 mb-2">
            Career Profile
          </h2>
        ...
        <div className="bg-[#121212]/90 border border-slate-800 rounded-3xl p-6 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] backdrop-blur-xl flex flex-col items-center text-center">
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-xl leading-relaxed mb-8">
            You can download my updated resume below to check out my complete
            academic background, technical skills, and detailed project
            experiences. Feel free to connect with me on my professional
            profiles!
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mb-10">
            {/* View Resume */}
            <a
              href="/Raghuveer_Kumawat_Resume.pdf"
              target="_blank"
            ...
            <a
              href="/Raghuveer_Kumawat_Resume.pdf"
              download="Raghuveer_Kumawat_Resume.pdf"
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-5 py-2.5 rounded-xl bg-[#1a1a1a] border border-slate-800 text-slate-200 hover:text-white hover:border-orange-500 hover:bg-orange-600/20 text-xs sm:text-sm font-medium transition-all duration-300"
              >
                LinkedIn Profile
              </a>
